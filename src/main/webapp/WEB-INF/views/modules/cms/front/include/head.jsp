...
<meta name="author" content="http://addone.synology,me:7070/Blog"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStatic}/common/heracles.min.css" type="text/css" rel="stylesheet" />
