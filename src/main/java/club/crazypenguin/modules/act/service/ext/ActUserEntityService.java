...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new club.crazypenguin.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new club.crazypenguin.modules.sys.entity.User(null, userId)))){
